...
<html>
    ...
    <head>
        ...
        <script>
            ...
            var retrieveMessages ="#retrieveMessages";
            ...
            function getMessages(){
                ...
                if(friend != "default"){
                    $(retrieveMessages).append("<input type='hidden' name='friendId' value='"+friend+"'/>");
                    $(retrieveMessages).trigger("submit");
                }
            }
        </script>
        ${message_error}
    ...
    <body class="body">
        ...
        <!-- CONTENT -->
        <%@include file="/breakdown/messaging/messagingForm.jsp" %>
